...
export const createPost = async (postData) => {
  ...
  // Remove pendingFile from what gets saved (it was only for the upload step)
  const { pendingFile, ...dataToSave } = postData;
